...
class CocoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.att_feats_folder is not None:
            #mimic
            # self.att_feats_folder = '/media/mount/'
            ...
            # self.att_feats_folder = '/mnt/sda/'
            # att_feats_frontal = np.load(os.path.join(self.att_feats_folder,  str(image_id) + '-AP.npz'))['feat']
            # att_feats_lateral = np.load(os.path.join(self.att_feats_folder,  str(image_id) + '-PA.npz'))['feat']
            # openi
